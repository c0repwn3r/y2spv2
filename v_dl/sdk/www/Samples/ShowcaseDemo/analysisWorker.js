...
let licenses = ["291-990-011-548-883-275-738-041-539-138-740.vlc", "248-147-647-778-748-993-365-066-111-665-360.vlc"];
...
function callAnalysis_stream(faceData, analysisData, faceIndex, options)
{
	...
	if (genderValid)
	{
		...
		//console.log("gender detection failed");
	}
	...
	if (ageValid)
	{
		...
		//console.log("age detection failed");
		return;
	}
}
