...
#region Callback Function for WEBGL
    ...
    { 
		...
		VisageTrackerNative._getFaceBoundingBox(ref rectangle, faceIndex);

		Rectangle[faceIndex].x = rectangle.x;
		Rectangle[faceIndex].y = rectangle.y;
		Rectangle[faceIndex].width = rectangle.width;
		Rectangle[faceIndex].height = rectangle.height;

		//Debug.Log("Bounding Box x: " + Rectangle[faceIndex].x + " y: " + Rectangle[faceIndex].y + " width: " + Rectangle[faceIndex].width + " height:" + Rectangle[faceIndex].height);
        //
